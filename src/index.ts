...
function showHelp(): void {
  ...
  console.log(chalk.gray('  bun run src/index.ts'));
  console.log(chalk.gray('  bun run src/index.ts chat "What can you do?"'));
  console.log(chalk.gray('  bun run src/index.ts init'));
}
